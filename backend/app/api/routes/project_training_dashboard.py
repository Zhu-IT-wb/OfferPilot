...
class ProjectProfileRequest(BaseModel):
    ...
    project_source: str = Field(default="", max_length=40)
    background: str = Field(default="", max_length=3000)
    responsibility_categories: List[str] = Field(default_factory=list, max_length=20)
    ...
    metrics_status: str = Field(default="", max_length=20)
    outcome_categories: List[str] = Field(default_factory=list, max_length=20)
